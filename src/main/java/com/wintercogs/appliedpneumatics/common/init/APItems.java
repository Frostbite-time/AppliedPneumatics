...
public class APItems
{
    ...
    private static List<DeferredItem<AirStorageCell>> CELLS = new ArrayList<>();
    private static List<DeferredItem<PortableAirStorageCell>> PORTABLE_CELLS = new ArrayList<>();
    ...
    // 气体元件 1K ~ 256M
    public static final DeferredItem<AirStorageCell> AIR_CELL_1K = registerCell("air_cell_1k",
    ...
    public static final DeferredItem<AirStorageCell> AIR_CELL_16K = registerCell("air_cell_16k",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    1.5f,
                    16));

    public static final DeferredItem<AirStorageCell> AIR_CELL_64K = registerCell("air_cell_64k",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    2.0f,
                    64));

    public static final DeferredItem<AirStorageCell> AIR_CELL_256K = registerCell("air_cell_256k",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    2.5f,
                    256));

    public static final DeferredItem<AirStorageCell> AIR_CELL_1M = registerCell("air_cell_1m",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    3.0f,
                    1024));

    public static final DeferredItem<AirStorageCell> AIR_CELL_4M = registerCell("air_cell_4m",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    3.5f,
                    4096));

    public static final DeferredItem<AirStorageCell> AIR_CELL_16M = registerCell("air_cell_16m",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    4.0f,
                    16384));

    public static final DeferredItem<AirStorageCell> AIR_CELL_64M = registerCell("air_cell_64m",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    4.5f,
                    65536));

    public static final DeferredItem<AirStorageCell> AIR_CELL_256M = registerCell("air_cell_256m",
            () -> new AirStorageCell(new Item.Properties().stacksTo(1),
                    5.0f,
                    262144));

    // 便携元件
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_1K = registerPortableCell("portable_air_cell_1k",
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_4K = registerPortableCell("portable_air_cell_4k",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    1.0f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_16K = registerPortableCell("portable_air_cell_16k",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    1.5f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_64K = registerPortableCell("portable_air_cell_64k",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    2.0f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_256K = registerPortableCell("portable_air_cell_256k",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    2.5f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_1M = registerPortableCell("portable_air_cell_1m",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    3.0f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_4M = registerPortableCell("portable_air_cell_4m",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    3.5f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_16M = registerPortableCell("portable_air_cell_16m",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    4.0f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_64M = registerPortableCell("portable_air_cell_64m",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    4.5f,
    ...
    public static final DeferredItem<PortableAirStorageCell> PORTABLE_AIR_CELL_256M = registerPortableCell("portable_air_cell_256m",
            () -> new PortableAirStorageCell(APMenus.PORTABLE_AIR_CELL_TYPE,
                    new Item.Properties().stacksTo(1),
                    0x80caff,
                    5.0f,
    ...
    public static List<DeferredItem<AirStorageCell>> getCELLS()
    {
        return Collections.unmodifiableList(CELLS);
    }

    public static List<DeferredItem<PortableAirStorageCell>> getPortableCells()
    {
        return Collections.unmodifiableList(PORTABLE_CELLS);
    }

    public static DeferredItem<AirStorageCell> registerCell(String name, Supplier<AirStorageCell> supplier)
    {
    ...
    public static DeferredItem<PortableAirStorageCell> registerPortableCell(String name, Supplier<PortableAirStorageCell> supplier)
    {
        var cell = ITEMS.register(name, supplier);
